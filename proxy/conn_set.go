...
func (c *Session) handleSet(stmt *sqlparser.Set, sql string) error {
	...
	// var err error
	// for _, v := range stmt.Exprs[0].Name.Name {
...
// func (c *Session) handleSetAutoCommit(val sqlparser.ValExpr) error {

// 	var stmt *sqlparser.Predicate
// 	var ok bool
// 	if stmt, ok = val.(*sqlparser.Predicate); !ok {
...
// func (c *Session) handleSetNames(val sqlparser.IValExpr) error {
...
func (c *Session) handleOtherSet(stmt sqlparser.Statement, sql string) error {
